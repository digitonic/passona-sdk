...
class UpdateTest extends BaseTestCase
{
    protected function setUp(): void
    {
        ...
        $this->mock = new MockHandler([
            new Response(200, [], '{"data":{"uuid":"c611e89e-fa6a-11e9-b302-0a5864600225","team_id":"","sender":"NewSendUp","status":"1","created_at":"2019-10-29 16:40:10","updated_at":"2019-10-29 16:40:10","links":[{"rel":"self","uri":"https:\/\/staging.passona.co.uk\/api\/2.0\/senders\/c611e89e-fa6a-11e9-b302-0a5864600225"}]}}')
        ]);
    ...
    public function it_can_create_a_sender_in_passona()
    {
        ...
        $response = $usage->put($senderUuid, $data);
