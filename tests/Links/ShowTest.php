...
class ShowTest extends BaseTestCase
{
    protected function setUp(): void
    {
        ...
        $this->mock = new MockHandler([
            new Response(200, [], '{"data":{"uuid":"85f7b244-faf5-11e9-a5d9-0a5864600115","vanity_domain_uuid":"4d47ca82-f63c-11e9-a674-0a58646002d8","template_uuid":"ae17d458-fa63-11e9-83fe-0a58646001fd","name":"New Link","destination":"https:\/\/digitonic.co.uk","created_at":"2019-10-30 09:13:23","updated_at":"2019-10-30 09:13:23"}}')
        ]);
    ...
    public function it_can_show_a_specific_keyword()
    {
        ...
        $response = $usage->get($linkUuid, false, null);

        $this->assertInstanceOf(Collection::class, $response);
        $this->assertCount(1, $response);
        $this->assertEquals($linkUuid, $response['data']->uuid);
